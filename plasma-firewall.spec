...
Version  : 6.4.0
Release  : 25
URL      : https://download.kde.org/stable/plasma/6.4.0/plasma-firewall-6.4.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.4.0/plasma-firewall-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.4.0/plasma-firewall-6.4.0.tar.xz.sig
...
%setup -q -n plasma-firewall-6.4.0
cd %{_builddir}/plasma-firewall-6.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750197932
mkdir -p clr-build
pushd clr-build
