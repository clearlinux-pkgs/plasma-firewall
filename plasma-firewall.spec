...
Version  : 6.3.0
Release  : 19
URL      : https://download.kde.org/stable/plasma/6.3.0/plasma-firewall-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.0/plasma-firewall-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/plasma-firewall-6.3.0.tar.xz.sig
...
%setup -q -n plasma-firewall-6.3.0
cd %{_builddir}/plasma-firewall-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739306762
mkdir -p clr-build
pushd clr-build
