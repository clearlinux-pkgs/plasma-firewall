...
Version  : 6.1.3
Release  : 8
URL      : https://download.kde.org/stable/plasma/6.1.3/plasma-firewall-6.1.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.3/plasma-firewall-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/plasma-firewall-6.1.3.tar.xz.sig
...
%setup -q -n plasma-firewall-6.1.3
cd %{_builddir}/plasma-firewall-6.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721168299
mkdir -p clr-build
pushd clr-build
