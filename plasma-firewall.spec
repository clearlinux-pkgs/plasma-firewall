...
Source0  : https://download.kde.org/stable/plasma/6.0.4/plasma-firewall-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/plasma-firewall-6.0.4.tar.xz.sig
...
%setup -q -n plasma-firewall-6.0.4
cd %{_builddir}/plasma-firewall-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713364052
mkdir -p clr-build
pushd clr-build
