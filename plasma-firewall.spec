...
Version  : 6.1.2
Release  : 7
URL      : https://download.kde.org/stable/plasma/6.1.2/plasma-firewall-6.1.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.2/plasma-firewall-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/plasma-firewall-6.1.2.tar.xz.sig
...
%setup -q -n plasma-firewall-6.1.2
cd %{_builddir}/plasma-firewall-6.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720632743
mkdir -p clr-build
pushd clr-build
