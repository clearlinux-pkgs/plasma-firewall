...
Version  : 6.3.2
Release  : 21
URL      : https://download.kde.org/stable/plasma/6.3.2/plasma-firewall-6.3.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.2/plasma-firewall-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/plasma-firewall-6.3.2.tar.xz.sig
...
%setup -q -n plasma-firewall-6.3.2
cd %{_builddir}/plasma-firewall-6.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741243569
mkdir -p clr-build
pushd clr-build
