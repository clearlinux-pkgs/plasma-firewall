...
Version  : 6.2.0
Release  : 13
URL      : https://download.kde.org/stable/plasma/6.2.0/plasma-firewall-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.0/plasma-firewall-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/plasma-firewall-6.2.0.tar.xz.sig
...
%setup -q -n plasma-firewall-6.2.0
cd %{_builddir}/plasma-firewall-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728780835
mkdir -p clr-build
pushd clr-build
